...
public class Railway_Testcase09 extends Railway_BaseTest{
    @Test
    public void TC09(){
        ...
        Railway_ChangePasswordPage changePasswordPage = loginPage.gotoChangePassword();
        ...
        Assert.assertEquals(actualMsg, expectedMsg, "Change pass Done");
